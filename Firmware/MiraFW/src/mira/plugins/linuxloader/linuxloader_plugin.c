...
static struct linux_loader_t* LinuxLoader = NULL;
...
uint8_t linuxloaderplugin_load(struct linuxloader_plugin_t* plugin);
uint8_t linuxloaderplugin_unload(struct linuxloader_plugin_t* plugin);
int32_t linuxloaderplugin_findFreeThread(struct linuxloader_plugin_t* plugin);

void cheatplugin_prepareScan(struct linuxloader_plugin_t* plugin, int pid, uint8_t* data, uint32_t dataLen);
uint64_t cheatplugin_getResultsCount(struct linuxloader_plugin_t* headResult);
...
void linux_loader_plugin_init(struct linuxloader_plugin_t* plugin)
{
	plugin->plugin.description = "LinuxLoaderPlugin";
	plugin->plugin.name = "LinuxLoaderPlugin";
	plugin->plugin.plugin_load = (uint8_t(*)(void*)) linuxloaderplugin_load;
	plugin->plugin.plugin_unload = (uint8_t(*)(void*)) linuxloaderplugin_unload;
...
uint8_t linuxloaderplugin_load(struct cheat_plugin_t* plugin)
{
...
uint8_t linuxloaderplugin_unload(struct cheat_plugin_t* plugin)
{
...
int32_t linuxloaderplugin_findFreeThread(struct cheat_plugin_t* plugin)
/*
Finds a free index
